...
- **Upload Endpoint**
  ...
  ```console
   curl -X POST -F "file=@C:\Users\Hishan\Desktop\microservice\New folder\microservices-python-app-main\assets\video.mp4" -H "Authorization: Bearer <your-token>" http://3.81.14.142:30002/upload
